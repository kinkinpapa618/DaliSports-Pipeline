# upload_yt_nopublish_pickleball.py - Upload video pickleball len YouTube, dien title/chapters
...
LOG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "upload_yt_pickleball_log.txt")

VIDEO_FILE = "pickleball.mp4"
NORMS_FILE = "pickleball_timeline_norms.txt"
...
async def main():
    ...
    print("=" * 60, flush=True)
    print("UPLOAD YOUTUBE - PICKLEBALL (KHONG TU PUBLISH)", flush=True)
    ...
    async with async_playwright() as p:
        ...
        print("  [+] Da chon tep, cho tai len hoan tat...", flush=True)
